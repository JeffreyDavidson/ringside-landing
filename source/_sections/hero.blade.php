<section class="hero" aria-labelledby="hero-title">
    ...
    <x-page-width class="hero-content">
        <p class="hero-badge">Built for independent wrestling promoters</p>
        <x-display-heading tag="h1" id="hero-title" class="hero-title"><span>Run the show.</span><span class="text-signal">Own the story.</span></x-display-heading>
...
<nav class="feature-index" aria-label="Explore the features">
    <x-page-width class="grid grid-cols-4">
